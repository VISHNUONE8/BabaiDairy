...
import com.andrayudu.babaidairy.databinding.CustomerOrdersItemBinding
...
class OrdersViewHolder(val binding: CustomerOrdersItemBinding,val datesList: ArrayList<Int>): RecyclerView.ViewHolder(binding.root){
    fun bind(
        ...
        //if the orders date is same as above ones then we will hide the date display Textview
